...
export function PdfToWordTool() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      console.error(`[PdfToWordTool] ${e.stack || e.message}`)
    } finally {
      setProcessing(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      {!file ? (
        ...
        >
          ...
          <p className="text-sm text-gray-400 mb-3">Converts to editable DOCX format (max {formatFileSize(MAX_FILE_SIZE)})</p>
