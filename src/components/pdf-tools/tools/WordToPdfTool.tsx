...
export function WordToPdfTool() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      console.error(`[WordToPdfTool] ${e.stack || e.message}`)
    } finally {
      setProcessing(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      {!file ? (
        ...
        >
          ...
          <p className="text-gray-700 font-medium mb-1">Drag & drop a Word document here</p>
          <p className="text-sm text-gray-400 mb-3">.docx and .doc files supported (max {formatFileSize(MAX_FILE_SIZE)})</p>
