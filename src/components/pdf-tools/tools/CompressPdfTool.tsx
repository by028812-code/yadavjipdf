...
import { Upload, X, FileText, Loader2, Download, CheckCircle, AlertTriangle } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      {!file ? (
        ...
        >
          ...
          <p className="text-sm text-gray-400 mb-3">or click to browse (max {formatFileSize(MAX_FILE_SIZE)})</p>
          ...
          {result.originalSize && result.compressedSize && (
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="bg-white rounded-lg p-2">
                ...
                <p className="text-sm font-semibold text-gray-700">{formatFileSize(result.originalSize)}</p>
              </div>
              <div className="bg-white rounded-lg p-2">
                <p className="text-xs text-gray-400">Compressed</p>
                <p className="text-sm font-semibold text-green-700">{formatFileSize(result.compressedSize)}</p>
              </div>
              <div className="bg-white rounded-lg p-2">
